...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, conver_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourStart), hourEnd: (0, conver_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourEnd) });
    }));
}));
